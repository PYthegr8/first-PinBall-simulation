''' Papa Yaw Owusu Nti
    ...
    and animates a bouncing compundshape within the pinball window 
...
def main():
    ...
    # create a custom shape assigned as ball, give it an initial velocity and acceleration, and draw it

    ball = pho.BallonBlock(
        win, x=20, y=54, width=4, height=6, tip_height=0, color=[0, 0, 128] 
    )
